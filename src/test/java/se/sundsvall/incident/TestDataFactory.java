...
public final class TestDataFactory {
    ...
    public static AttachmentRequest buildAttachmentRequest(Consumer<AttachmentRequest> modifier) {
        var request = AttachmentRequest.builder()
    ...
    public static List<AttachmentDto> buildAttachmentDtoList(Integer count) {
        List<AttachmentDto> attachmentEntities = new ArrayList<>();
        for (int i = 0; i < count; i++) {
    ...
    public static EmailRequest buildMSVAEmailRequest() {
        ...
        return new EmailRequest()
                ...
                .subject("Somesubject")
                .htmlMessage("<p>Vattenmätare " + "splitDescription[0]" + " genererat larm" + "splitDescription[1]" + " klockan " + LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME) + "</p>");
