...
public class IncidentResource {
	...
	@GetMapping(path = "/internal/oep/status/{externalCaseId}")
	...
	@PatchMapping(path = "/statusupdate", produces = APPLICATION_PROBLEM_JSON_VALUE)
	ResponseEntity<Void> updateIncidentStatus(
	...
	@PatchMapping(path = "/feedbackupdate", produces = APPLICATION_PROBLEM_JSON_VALUE)
	ResponseEntity<Void> updateIncidentFeedback(
		@RequestParam(name = "id") final String incidentId,
